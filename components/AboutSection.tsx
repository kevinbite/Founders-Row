...
const AboutSection = () => {
  return (
    <section className="relative bg-black pt-12 sm:pt-16 md:pt-20 lg:pt-24 pb-4 sm:pb-6 md:pb-8 lg:pb-10 mt-44 sm:mt-24 md:mt-20 lg:mt-16 z-40 overflow-visible">
      {/* Background pattern */}
