...
const HeroSection = () => {
  return (
    ...
    >
      ...
      <div 
        className="absolute top-[32%] sm:top-[42%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] sm:w-[550px] sm:h-[550px] md:w-[650px] md:h-[650px] rounded-full animate-flicker"
        style={{
